...
public partial class Employee
{
    ...
    public string? EmpDivisionalhead { get; set; }
    ...
    public string? FdCertificateName { get; set; }

    public byte[]? FdCertificate { get; set; }

    public string? FdCertificateContenttype { get; set; }
    ...
    public string? SdCertificateName { get; set; }

    public byte[]? SdCertificate { get; set; }

    public string? SdCertificateContenttype { get; set; }
    ...
    public string? P1CertificateName { get; set; }

    public byte[]? P1Certificate { get; set; }

    public string? P1CertificateContenttype { get; set; }
    ...
    public string? P2CertificateName { get; set; }

    public byte[]? P2Certificate { get; set; }

    public string? P2CertificateContenttype { get; set; }
    ...
    public string? P3CertificateName { get; set; }

    public byte[]? P3Certificate { get; set; }

    public string? P3CertificateContenttype { get; set; }
    ...
    public string? P4CertificateName { get; set; }

    public byte[]? P4Certificate { get; set; }

    public string? P4CertificateContenttype { get; set; }
    ...
    public string? P5CertificateName { get; set; }

    public byte[]? P5Certificate { get; set; }

    public string? P5CertificateContenttype { get; set; }

    public string? EmpCvName { get; set; }

    public byte[]? EmpCv { get; set; }

    public string? EmpCvContenttype { get; set; }
    ...
    public string? EmpPhotoContenttype { get; set; }
    ...
    public DateTime? EmpEndletterdate { get; set; }

    public bool? IsActing { get; set; }

    public DateTime? ActingStartDate { get; set; }

    public virtual City? EmpCityNavigation { get; set; }

    public virtual Department? EmpDeptNavigation { get; set; }

    public virtual Grade? EmpGradeNavigation { get; set; }

    public virtual Location? EmpLocationNavigation { get; set; }

    public virtual Country? EmpNationalityNavigation { get; set; }

    public virtual Ou? EmpOuNavigation { get; set; }

    public virtual Paygroup? EmpPaygroupNavigation { get; set; }

    public virtual Designation? EmpPositionNavigation { get; set; }

    public virtual Region? EmpRegionNavigation { get; set; }
